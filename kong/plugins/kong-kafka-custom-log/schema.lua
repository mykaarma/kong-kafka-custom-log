local types = require "kong.plugins.kong-kafka-custom-log.types"
  ...
  fields = {
    {
      config = {
        ...
        fields = {
          ...
          { bootstrap_servers = { type = "array", required = true, elements = { type = "string" } },  },
          { topic = { type = "string", required = true }, },
          { timeout = { type = "number", default = 10000 }, },
          { keepalive = { type = "number", default = 60000 }, },
          { producer_request_acks = { type = "number", default = 1 },  },
